...
%{?with_gnomevfs:BuildRequires:	gnome-vfs2-devel >= 2.9.90}
BuildRequires:	libart_lgpl-devel >= 2.3.15
%{?with_libcroco:BuildRequires:	libcroco-devel >= 0.6.0}
%{?with_gnomeprint:BuildRequires:	libgnomeprintui-devel >= 2.8.2}
...
%{?with_gnomevfs:Requires:	gnome-vfs2-devel >= 2.9.90}
